                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltBrand">
                                    ...
                                    @foreach($brand as $item_brand)
                                        @if($product['brand_id'] == $item_brand['id'])
                                            <option value="{!!$item_brand->id!!}" selected="selected">{!!$item_brand->brand_name!!}</option>
                                        @else
                                            <option value="{!!$item_brand->id!!}">{!!$item_brand->brand_name!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltMadein">
                                    ...
                                    @foreach($madein as $item_made)
                                        @if($product['made_id'] == $item_made['id'])
                                            <option value="{!!$item_made->id!!}" selected="selected">{!!$item_made->country!!}</option>
                                        @else
                                            <option value="{!!$item_made->id!!}">{!!$item_made->country!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltColor">
                                    ...
                                    @foreach($color as $item_color)
                                        @if($product['color_id'] == $item_color['id'])
                                            <option value="{!!$item_color->id!!}" selected="selected">{!!$item_color->color_name!!}</option>
                                        @else
                                            <option value="{!!$item_color->id!!}">{!!$item_color->color_name!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltMaterial">
                                    ...
                                    @foreach($mate as $item_mate)
                                        @if($product['mate_id'] == $item_mate['id'])
                                            <option value="{!!$item_mate->id!!}" selected="selected">{!!$item_mate->mate_name!!}</option>
                                        @else
                                            <option value="{!!$item_mate->id!!}">{!!$item_mate->mate_name!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltSize">
                                    ...
                                    @foreach($size as $item_size)
                                        @if($product['size_id'] == $item_size['id'])
                                            <option value="{!!$item_size->id!!}" selected="selected">{!!$item_size->size_name!!}</option>
                                        @else
                                            <option value="{!!$item_size->id!!}">{!!$item_size->size_name!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sltSale">
                                    @foreach($sale as $item_sale)
                                        @if($product['sale_id'] == $item_sale['id'])
                                            <option value="{!!$item_sale->id!!}" selected="selected">{!!$item_sale->sale_event!!}</option>
                                        @else
                                            <option value="{!!$item_sale->id!!}">{!!$item_sale->sale_event!!}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
